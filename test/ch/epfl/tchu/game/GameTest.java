...
//		expectedInfoQueue.offer(info.drewTickets(chosenTicketsCount));
    ...
    public static class PlayerTest implements Player {
        ...
        public TurnKind nextTurn() {
            turnCount++;
            System.out.println("C'est ton tour nÂ°"+turnCount+"! :3");
            ...
            System.out.println("Tu as "+state.carCount()+" wagons ! "+playerNames.get(ownId.next())+" en a quand Ã  lui "+gameState.playerState(ownId.next()).carCount()+". ");
            System.out.println("Pour rappel tu tu possÃ¨de ces cartes: " + state.cards().toString());
        ...
        public Route claimedRoute() {
            ...
            System.out.println("Entrez ville d'arrivÃ©e: ");
...
//            seed += i * 777;
    ...
    private static final class TestPlayer implements Player {
        ...
        public TurnKind nextTurn() {
            turnCounter += 1;
            if (turnCounter > TURN_LIMIT)
                throw new Error("Trop de tours jouÃ©s !");

            // DÃ©termine les routes dont ce joueur peut s'emparer
